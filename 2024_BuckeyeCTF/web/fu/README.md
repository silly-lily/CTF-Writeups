# Challenge Name 
fu is a web challenge focusing. We are given a website where we cannot use developer tools:
...
We can use the `curl` command to view the contents of the webpage without using developer tools. The webpage content includes the flag:
