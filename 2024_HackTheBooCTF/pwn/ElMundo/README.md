# El Mundo
El Mundo is a pwn challenge focusing on buffer overflow attacks.

## Getting the Offset
Using netcat, we can access the challenge instructions:
...
Lastly we change the offsett and reurn address:
