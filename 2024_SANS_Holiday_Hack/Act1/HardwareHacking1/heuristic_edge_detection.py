...
def find_first_col(matched_slices): # Added
...
def main():
    ...
    input_folder = '.../slices' # Update
    output_path = '.../assembled_image.png' # Update
    
    slices = load_images(input_folder)
    matched_slices = find_best_match(slices)
    matched_slices = find_first_col(matched_slices) # Added
